...
- 中午需要休息 1 小時
- 下午要去市場買菜。
- 4:30 要接孫子，搭公車方式，單次轉乘30分鐘。

```text
我明天上午 9:30 到醫院回診，預計 2 小時；下午要去市場買菜，4:30 要接孫子。搭公車，單次轉乘請保留 30 分鐘，膝蓋不適，中午需要休息 1 小時。
請用表格安排 8:00 至 18:00 的行程，分成固定與可調整事項，不要排得太緊。
```

![](./Image/社區大學_AI生活應用/一日行程時間規劃表.png)
...
- 下午開始下大雨，市場改成超市，公車可能延誤 20 分鐘。請保留最重要的行程並重新安排，列出被延後或取消的項目。
...
請依「今天、這週、本月、有空再做」分類；為每項補上第一個具體行動，但不要替我編造截止日期。
```
...
```text
請把「下週二回診」改寫成三則提醒：一週前確認掛號、前一天準備證件與藥單、當天出門前檢查。請告訴我應設定在哪些日期，但不宣稱已替我設定。
```
...
根據上一題規畫好得行程，加入「週二身體不舒服、週五臨時加班」，請 AI 移動活動，但保留睡眠與必要就醫時間。
...
依據上一題，其中一天突然下豪語，要求替換戶外景點，但不增加大量車程。
...
安排「第一次來台南的朋友」一日行程，上午一個景點，下午兩個景點，晚上一個景點與一次休息，要考量午餐與晚餐。
...
學生說國華街要開一間新的好市多，請幫我用地圖或官方網站確認事情真偽、地址、營業時間與休館日。
