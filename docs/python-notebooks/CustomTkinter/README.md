...
- [YT：What's the difference between a GUI and a CLI?](https://www.youtube.com/watch?v=w9u0d4C95Zs)
- [YT：一口气看懂GUI如何把电脑从“天书”变日常【GUI发展史｜仿生之旅】](https://www.youtube.com/watch?v=GdrEkSmItB4)
- [YT：整理下Python常用的GUI模块](https://www.youtube.com/watch?v=w3GFf2ULdUo&t=1s)
...
- [連結：CustomTkinter文件](https://customtkinter.tomschimansky.com/)
...
## [建立你的第一個視窗](./customtkinter_src/建立你的第一個視窗.md)
...
- [範例：建立一個 Ctk Label](./customtkinter_src/建立一個Ctk_Label.md)
- [範例：基礎文字與字型設定](./customtkinter_src/基礎文字與字型設定.md)
...
- [範例：顯示圖片](./customtkinter_src/顯示圖片.md)
...
- [範例：CTk點擊計數器](./customtkinter_src/CTk點擊計數器.md)
  - Problem. 優化CTk點擊計數器
- [範例：CTk猜拳遊戲](./customtkinter_src/CTk猜拳遊戲.md)
  - Problem. 優化CTk猜拳遊戲
- [範例：CTk一番賞抽獎機](./customtkinter_src/CTk一番賞抽獎機.md)
  - Problem. 優化CTk猜拳遊戲
